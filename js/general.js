...
var dd = $("#dropdown"), // the dropdown container
	...
	dir = "menu", // this is the directory where your Ajax-loaded files reside
	ext = ".html", // this is the file extension of your Ajax-loaded files; change to .php if you use that
	speed = 1000, // this is the speed, in milliseconds, of the animated menus
	...
	closeLinkString = "<div class='close'><a id='close-link' onclick=\"Megadropdowns.closeDropDown(); return false;\"><img src='images/close-cross.jpg'></a></div>", // this is the close button, could be an image if you want
	...
	urlString = "",
	menusArray = "",
	menuLinks = $("nav ul li.menuPosition2>a"), // this is the often-used link collection; ">" makes sure sublinks aren't included
	...
	populateMenu: function (currentLink) {
		...
		dd.slideDown(speed, function () {
			...
			$("nav ul li.menuPosition2>a.active").find("span").html(upArrow);
